...
/**
 * Created by Jason Chen on 2017/8/7.
 */
...
public class MySlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    public void setViewPager(String[] titles) {
        ...
        mTitles = new ArrayList<>();
        Collections.addAll(mTitles, titles);
        notifyDataSetChangedNotViewPager();
    }
     ...
     * 更新数据
     */
    public void notifyDataSetChangedNotViewPager() {
        mTabsContainer.removeAllViews();
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    //setter and getter
    public void setCurrentTabNotViewPager(int currentTab) {
