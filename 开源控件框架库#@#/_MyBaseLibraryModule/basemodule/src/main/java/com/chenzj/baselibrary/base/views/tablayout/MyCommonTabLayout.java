package com.nanbo.vocationalschools.widget.tablayout;
...
/**
 * Created by Jason Chen on 2017/11/24.
 */
...
public class MyCommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    public MyCommonTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mValueAnimator = ValueAnimator.ofObject(new MyCommonTabLayout.PointEvaluator(), mLastP, mCurrentP);
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    public void onAnimationUpdate(ValueAnimator animation) {
        View currentTabView = mTabsContainer.getChildAt(this.mCurrentTab);
        MyCommonTabLayout.IndicatorPoint p = (MyCommonTabLayout.IndicatorPoint) animation.getAnimatedValue();
    ...
    private MyCommonTabLayout.IndicatorPoint mCurrentP = new MyCommonTabLayout.IndicatorPoint();
    private MyCommonTabLayout.IndicatorPoint mLastP = new MyCommonTabLayout.IndicatorPoint();

    class PointEvaluator implements TypeEvaluator<MyCommonTabLayout.IndicatorPoint> {
        @Override
        public MyCommonTabLayout.IndicatorPoint evaluate(float fraction, MyCommonTabLayout.IndicatorPoint startValue, MyCommonTabLayout.IndicatorPoint endValue) {
            float left = startValue.left + fraction * (endValue.left - startValue.left);
            float right = startValue.right + fraction * (endValue.right - startValue.right);
            MyCommonTabLayout.IndicatorPoint point = new MyCommonTabLayout.IndicatorPoint();
            point.left = left;
            point.right = right;
            return point;
        }
