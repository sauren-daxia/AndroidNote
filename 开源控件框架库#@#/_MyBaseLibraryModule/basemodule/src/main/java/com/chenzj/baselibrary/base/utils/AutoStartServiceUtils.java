...
/**
 * Created by Jason Chen on 2017/9/15.
 * 调换自启动页面
 */

public class AutoStartServiceUtils {
        ...
        try {
            ...
            if (getMobileType().equals("Xiaomi")) { // 红米Note4测试通过
                ...
                if (Build.VERSION.SDK_INT >= 9) {
                    ...
                    intent.setData(Uri.fromParts("package", con.getPackageName(), null));
                } else if (Build.VERSION.SDK_INT <= 8) {
                    intent.setAction(Intent.ACTION_VIEW);
                    intent.setClassName("com.android.settings", "com.android.settings.InstalledAppDetails");
                    intent.putExtra("com.android.settings.ApplicationPkgName", con.getPackageName());
                }
            }
