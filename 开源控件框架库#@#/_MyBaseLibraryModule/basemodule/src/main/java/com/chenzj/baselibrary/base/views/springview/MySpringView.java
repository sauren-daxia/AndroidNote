 ...
 */
public class MySpringView extends ViewGroup {
...
//        return false;
    ...
    private boolean isClearFooter;

    public boolean isClearFooter() {
        return isClearFooter;
    }

    public void setClearFooter(boolean clearFooter) {
        isClearFooter = clearFooter;
    }
    private void doMove() {
        if (type == Type.OVERLAP) {
            //记录移动前的位置
